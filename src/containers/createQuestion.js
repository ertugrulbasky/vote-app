...
const CreateQuestion = ({ dispatch }) => {
    ...
    return (
        <Card title='Create Question'  style={cardStyle}>
            <Card.Grid style={gridStyle}>
                <Form name="basic" labelCol={{span: 4}} wrapperCol={{span: 16}} initialValues={{remember: true}} onFinish={create} autoComplete="off">
                  ...
                  <Form.Item label="Choices" name="choices" rules={[{required: true,message: 'Please enter the options with a comma between them.For example(example1,example2)'}]}><TextArea rows={4}/></Form.Item>
